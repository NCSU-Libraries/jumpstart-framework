...
Additionally, we anticipate that the framework presented here could be adapted to create similar programs for other audiences (a Jumpstart Program for current librarians and archivists hoping to build their tech skills, for example). 
...
<center>
![](./images/jumpstart_stock_1.jpg)
</center>

<br>

[Next >> Process Overview](https://ncsu-libraries.github.io/jumpstart-framework/timeline.html)
