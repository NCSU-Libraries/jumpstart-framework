...
- Equipment: 
  ...
  + Do you have a reliable internet connection at the location you will be joining us from?
...
- Accessibility:
  + Do you require any accessibility accommodations for the week of the program?
  + Do you have access to any assistive technology you might need for the week?

We were able to use the information gleaned from this survey to plan our technical workshops around folks experiences and skill levels. Information obtained in this survey also prompted us to begin working on the process of securing live captioning and inserting more break time into our schedule. For live captioning, we worked with [CaptionSync](https://www.automaticsync.com/captionsync/) to secure services. 
...
A couple weeks before the program, we gave participants access to [a shared Google Drive folder](https://drive.google.com/drive/folders/1OkBHpvKMCA03NVwjqr74mhodNiX6-DV8?usp=sharing) that we pitched as their one-stop-shop for all things Jumpstart, including all pre-program support materials such as the program schedule with Zoom links and the code of conduct, program support materials (such as workshop slides and glossaries), as well as all post-program support materials (including guides for continued learning, etc.). We outlined the folders contents in a [README document.](https://docs.google.com/document/d/1kXKzZWbE2yno_vcpjGJLTYw2H_T35Az2Q5OsswAeKe4/edit?usp=sharing) 
...
[Next >> Step 6: Program Delivery](https://cullerth.github.io/jumpstart_website/delivery.html)