...
A couple weeks before the program, we gave participants access to [a shared Google Drive folder](https://drive.google.com/drive/folders/1OkBHpvKMCA03NVwjqr74mhodNiX6-DV8?usp=sharing) that we pitched as their one-stop-shop for all things Jumpstart, including all pre-program support materials such as the program schedule with Zoom links and the code of conduct, program support materials (such as workshop slides and glossaries), as well as all post-program support materials (including guides for continued learning, etc.). We outlined the folder's contents in a [README document.](https://docs.google.com/document/d/1kXKzZWbE2yno_vcpjGJLTYw2H_T35Az2Q5OsswAeKe4/edit?usp=sharing) 
